<?php
// ==================================================
// get_business_list.php — 業務列表查詢 API（統一 Session / CORS 版）
// ==================================================
...
ini_set('error_log', __DIR__ . '/get_business_list_error.log');
...
try {
  ...
  if ($keyword !== '') {
    $sql .= "
      WHERE 
        ...
        business_id COLLATE utf8mb4_unicode_ci LIKE :kw OR
  ...
  error_log('[ERROR get_business_list.php] ' . $e->getMessage());
